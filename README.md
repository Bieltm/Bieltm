...
<head>
    ...
    <style>
        /* Això farà que el contenidor de les habilitats posi les imatges en fila */
        .skills {
            display: flex;       /* Activa el mode flexbox */
            flex-direction: row; /* Posa els elements en fila */
            flex-wrap: wrap;     /* Si no caben en una fila, passen a la següent (opcional) */
            align-items: center; /* Alinea les icones verticalment al centre */
            gap: 20px;           /* Afegeix espai entre les icones */
            margin-top: 20px;
        }

        /* Opcional: per assegurar que les imatges no es deformin */
        .skills img {
            object-fit: contain;
        }
    </style>
